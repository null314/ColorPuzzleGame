...
1. Игровое поле в начале заполнено цветными квадратами.
Кружками обозначены тайлы, которые можно *сократить*.

![Начало игры](Screens/screen_5.jpg)

2. Если не осталось ни одного тайла, обозначенного кружком, значит больше нечего сокращать.
 Следует нажать кнопку "ADD"

![Игровое поле после сокращения](Screens/screen_6.jpg)

3. После нажатия "ADD" на игровое поле добавляется такое же количество тайлов с теми же цветами (если читать слева направо сверху вниз).
Таким образом количество тайлов увеличилось вдвое.
...
В ходе игры некоторые цвета будут выходить из игры. 
